...
function s_basic_many_patches_bypatch_pathogen_day
...
% Start time
    for i=1:tt
        x_infl(1200,:)=500; %%%Add some inflammation-causing bacteria to patch 1 on day 5
